...
ControlUnit здесь считывает инструкцию. Затем декодер и устройство микропрограммного управления потактово исполняют иструкцию. Из МПУ отправляются сигналы для изменения данных и выгрузке новой инструкции из CR.
